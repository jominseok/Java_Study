...
CREATE TABLE `lecture` (
	...
	`le_room`	varchar(20)	not NULL,
	`le_schedule`	varchar(50) not null,
	`le_point`	int not null default 0 not NULL,
	`le_time`	int not null default 0 not NULL,
	`le_pr_num`	char(10)
);
...
ALTER TABLE `contect` ADD CONSTRAINT `PK_CONTECT` PRIMARY KEY (
	`ct_st_num`
);
...
ALTER TABLE `contect` ADD CONSTRAINT `FK_student_TO_contect_1` FOREIGN KEY (
	`ct_st_num`
)
REFERENCES `student` (
	`st_num`
