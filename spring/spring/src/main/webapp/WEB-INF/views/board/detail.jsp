...
<div>
	...
	<div class="input-group mb-3 mt-3">
		<button class="btn btn-outline-success btn-up col-6" data-state="1"><span class="text-up">추천(${board.bo_up})</span></button>
		<button class="btn btn-outline-success btn-down col-6" data-state="-1"><span class="text-down">비추천(${board.bo_down})</span></button>
	</div>
	<div>
		<label>내용</label>
...
function displayRecommend(){
	...
	if(state == 1){
		$('.btn-up, .btn-down').removeClass("btn-outline-success");
		$('.btn-up, .btn-down').addClass("btn-success");
	}else if(state == -1){
